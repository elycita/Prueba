...
@Named
public class GestionPedidoBL implements Serializable, MasterDaoInterfaceBl {
	...
	public List findAll() throws Exception {
		String sql = "select o from Pedido o where o.estado = 'PENDIENTE' order by o.fechaHora desc";

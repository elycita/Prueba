...
@Named
public class GestionEmpresaBL implements Serializable, MasterDaoInterfaceBl {
	...
	public List findAll() throws Exception {
		String sql = "select o from Empresa o";
		return masterDao.findAllQuery(Empresa.class, sql, null);
	}

...
@Named
public class GestionEmpleadoBL implements Serializable, MasterDaoInterfaceBl {
	...
	public List findAll() throws Exception {
		String sql = "select o from Empleado o";
		return masterDao.findAllQuery(Empleado.class, sql, null);
	}
